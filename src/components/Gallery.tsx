...
const galleryItems = [
  { src: '/activities/yakteaw.webp', title: 'Yakteaw', category: 'AI PROJECT' },
  { src: '/activities/SamoSIT.webp', title: 'SAMO SIT', category: 'LEADERSHIP' },
  { src: '/activities/climathon.webp', title: 'Climathon', category: 'HACKATHON' },
  { src: '/activities/kmuttstartupplayground1.webp', title: 'Startup Playground', category: 'EVENT' },
  { src: '/activities/charmcasecompetition.webp', title: 'Charm Case', category: 'COMPETITION' },
  { src: '/activities/SamoSIT3.jpg', title: 'Student Activities', category: 'ACTIVITIES' },
];
